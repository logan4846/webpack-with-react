...
export function markPendingPriorityLevel(
  ...
  const earliestPendingTime = root.earliestPendingTime;//NoWork
...
function findNextExpirationTimeToWorkOn(completedExpirationTime, root) {
  ...
  let nextExpirationTimeToWorkOn =
    earliestPendingTime !== NoWork ? earliestPendingTime : latestPingedTime;//NoWork
  ...
  let expirationTime = nextExpirationTimeToWorkOn;//NoWork
  if (
